...
//	"github.com/khu-dev/khumu-comment/_model"
...
//	mockCommentUseCase.EXPECT().Create(gomock.Any()).DoAndReturn(func(c *data.CommentInput) (*data.CommentOutput, error) {
//		articleID := 1
//		return &data.CommentOutput{
//			ID: 1,
//			Kind: "anonymous",
//			Author: &data.SimpleKhumuUserOutput{
//				Username: "jinsu",
//				Nickname: "테스트진수",
//				State: "active",
//			},
...
//	rootRouter := NewRootRouter(comment)
