...
func (bq *BoardQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	selector := builder.Select(t1.Columns(board.Columns...)...).From(t1)
	if bq.sql != nil {
		selector = bq.sql
		selector.Select(selector.Columns(board.Columns...)...)
	}
...
func (bgb *BoardGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(bgb.fields) > 1 {
		return nil, errors.New("ent: BoardGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := bgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bgb *BoardGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (bgb *BoardGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(bgb.fields) > 1 {
		return nil, errors.New("ent: BoardGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := bgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bgb *BoardGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (bgb *BoardGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(bgb.fields) > 1 {
		return nil, errors.New("ent: BoardGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := bgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bgb *BoardGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (bgb *BoardGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(bgb.fields) > 1 {
		return nil, errors.New("ent: BoardGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := bgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bgb *BoardGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (bs *BoardSelect) Strings(ctx context.Context) ([]string, error) {
	if len(bs.fields) > 1 {
		return nil, errors.New("ent: BoardSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := bs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bs *BoardSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (bs *BoardSelect) Ints(ctx context.Context) ([]int, error) {
	if len(bs.fields) > 1 {
		return nil, errors.New("ent: BoardSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := bs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bs *BoardSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (bs *BoardSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(bs.fields) > 1 {
		return nil, errors.New("ent: BoardSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := bs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bs *BoardSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (bs *BoardSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(bs.fields) > 1 {
		return nil, errors.New("ent: BoardSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := bs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (bs *BoardSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{board.Label}
	default:
		err = fmt.Errorf("ent: BoardSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (bs *BoardSelect) sqlQuery() sql.Querier {
	selector := bs.sql
