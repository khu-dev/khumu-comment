...
// The KhumuUserFunc type is an adapter to allow the use of ordinary
// function as KhumuUser mutator.
type KhumuUserFunc func(context.Context, *ent.KhumuUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f KhumuUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.KhumuUserMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.KhumuUserMutation", m)
	}
	return f(ctx, mv)
}

// The LikeCommentFunc type is an adapter to allow the use of ordinary
// function as LikeComment mutator.
type LikeCommentFunc func(context.Context, *ent.LikeCommentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LikeCommentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.LikeCommentMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LikeCommentMutation", m)
	}
	return f(ctx, mv)
}
